        ...
        <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-4">
                <div className="bg-white p-12 rounded-lg shadow-lg text-center max-w-2xl mx-auto">
                    <h3 className="text-3xl font-bold mb-4 text-gray-800">Stay Informed</h3>
                    ...
                    <form className="flex gap-2.5">
                        ...
                        <button type="submit" className="py-3 px-6 bg-blue-500 text-white border-none rounded-md font-semibold cursor-pointer">Subscribe</button>
                    </form>
                </div>
            </div>
        </section>
