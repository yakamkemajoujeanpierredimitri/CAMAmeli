            ...
            <div className="container mx-auto px-4">
                <article className="max-w-3xl mx-auto">
                    <header className="text-center mb-8 sm:mb-12">
                        <span className="inline-block py-1 px-4 bg-blue-500 text-white rounded-full text-sm mb-3 sm:mb-5">Training</span>
                        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-5 text-gray-800">What's New in AutoCAD 2024: What's Changing for Professionals</h1>
                        <div className="flex justify-center gap-4 sm:gap-8 mb-8 text-gray-600 text-base">
                    ...
                    <div className="w-full h-64 sm:h-96 rounded-lg overflow-hidden mb-6 sm:mb-10 shadow-xl">
                    ...
                    <div className="text-gray-700 text-base sm:text-lg leading-relaxed">
                        ...
                        <h2 className="text-2xl sm:text-3xl my-6 sm:my-10 text-gray-800">New intelligent drawing features</h2>
                        ...
                        <blockquote className="border-l-4 border-blue-500 p-4 sm:p-5 my-6 sm:my-8 bg-gray-50 italic text-gray-600">
                        ...
                        <h3 className="text-xl sm:text-2xl my-6 sm:my-8 text-gray-800">User Interface Improvement</h3>
                        ...
                        <ul className="my-5 ml-4 sm:ml-8 list-disc">
                        ...
                        <h2 className="text-2xl sm:text-3xl my-6 sm:my-10 text-gray-800">Enhanced cloud collaboration</h2>
                        ...
                        <ol className="my-5 ml-4 sm:ml-8 list-decimal">
                        ...
                        <h3 className="text-xl sm:text-2xl my-6 sm:my-8 text-gray-800">Security and data management</h3>
                    ...
                    <div className="flex flex-wrap gap-2 my-6 sm:my-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between my-8 sm:my-16 py-4 sm:py-8 border-t border-b border-gray-200">
                        <NavLink to="/programmes?concours" className="flex items-center gap-2 sm:gap-4 text-blue-500 font-semibold transition-colors duration-300 hover:text-blue-700 mb-4 sm:mb-0">
                        ...
                        <NavLink to="/programmes?temoignages" className="flex items-center gap-2 sm:gap-4 text-blue-500 font-semibold transition-colors duration-300 hover:text-blue-700 text-right">
                            <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 sm:p-8 my-8 sm:my-12 flex flex-col sm:flex-row gap-3 sm:gap-5 items-center sm:items-start">
                        <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-4 border-blue-500 flex-shrink-0">
                        ...
                        <div className="author-info text-center sm:text-left">
                            <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2.5 text-gray-800">Admin CAMA</h4>
                            <p className="text-blue-500 font-semibold mb-1 sm:mb-2.5">Editor-in-chief</p>
                    ...
                    <div className="my-12 sm:my-20">
                        <h2 className="text-2xl sm:text-3xl text-center mb-8 sm:mb-12 text-gray-800 relative">Comments (3)<div className="absolute bottom-[-15px] left-1/2 -translate-x-1/2 w-20 h-1 bg-blue-500 rounded-full"></div></h2>
                        ...
                        <div className="bg-gray-50 p-6 sm:p-10 rounded-lg my-8 sm:my-12">
                            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Leave a comment</h3>
                            <form>
                                ...
                                <button type="submit" className="inline-block py-2 px-4 sm:py-3 sm:px-6 bg-blue-500 text-white no-underline rounded-md font-semibold transition-colors duration-300 hover:bg-blue-700">Post Comment</button>
                            </form>
                        </div>
