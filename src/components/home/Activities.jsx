    ...
    return (
        <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-4">
                ...
                <h2 className="text-center text-4xl font-bold mb-4 text-gray-800">A complete range of training</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="activities-image">
                        <img src="https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Software training" className="w-full h-96 object-cover rounded-lg shadow-2xl" />
                    </div>
                    ...
                    <div className="activities-list">
                        <div className="flex gap-8 items-start">
                            ...
                            <div className="category-content">
                                <h3 className="text-3xl mb-4 text-gray-800">Software Training</h3>
                                <p className="text-gray-600 mb-8 leading-relaxed">Master the most requested professional software in architecture and engineering.</p>
