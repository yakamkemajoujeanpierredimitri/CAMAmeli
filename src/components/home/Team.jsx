    ...
    return (
        <section className="py-12 sm:py-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                <h2 className="text-center text-3xl sm:text-4xl font-bold mb-8 sm:mb-12 text-gray-800">Our Experts</h2>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mt-6 sm:mt-8">
                    <div className="text-center p-6 sm:p-8 rounded-lg shadow-lg transition-transform duration-300 hover:-translate-y-1">
                        <div className="w-32 h-32 sm:w-40 sm:h-40 mx-auto mb-4 sm:mb-6 rounded-full overflow-hidden border-4 border-blue-500">
                        ...
                        <div className="member-info">
                            <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-gray-800">Dr. Marie Kouame</h4>
                            <p className="text-blue-500 font-semibold mb-1 sm:mb-2">Academic Director</p>
                    ...
                    <div className="text-center p-6 sm:p-8 rounded-lg shadow-lg transition-transform duration-300 hover:-translate-y-1">
                        ...
                        <div className="member-info">
                            <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-gray-800">Eng. Jean Baptiste</h4>
                            <p className="text-blue-500 font-semibold mb-1 sm:mb-2">Training Manager</p>
                    ...
                    <div className="text-center p-6 sm:p-8 rounded-lg shadow-lg transition-transform duration-300 hover:-translate-y-1">
                        ...
                        <div className="member-info">
                            <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-gray-800">Prof. Aisha Traoré</h4>
                            <p className="text-blue-500 font-semibold mb-1 sm:mb-2">Pedagogical Coordinator</p>
