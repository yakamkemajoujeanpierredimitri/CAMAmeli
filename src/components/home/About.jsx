    ...
    return (
        <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-4">
                ...
                <h2 className="text-center text-4xl font-bold mb-4 text-gray-800">Excellence at the service of your success</h2>
                ...
                <div className="bg-white p-10 rounded-lg shadow-lg">
                    <h3 className="text-center text-3xl font-bold mb-8 text-gray-800">Our Objectives</h3>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-3 py-2">
                            <FontAwesomeIcon icon={faCheckCircle} className="text-green-500 text-xl" />
                            <span className="text-gray-600 text-base">Train competent professionals</span>
                        </div>
                        <div className="flex items-center gap-3 py-2">
                            <FontAwesomeIcon icon={faCheckCircle} className="text-green-500 text-xl" />
                            <span className="text-gray-600 text-base">Develop pedagogical innovation</span>
                        </div>
                        <div className="flex items-center gap-3 py-2">
                            <FontAwesomeIcon icon={faCheckCircle} className="text-green-500 text-xl" />
                            <span className="text-gray-600 text-base">Create a solid professional network</span>
                        </div>
                        <div className="flex items-center gap-3 py-2">
                            <FontAwesomeIcon icon={faCheckCircle} className="text-green-500 text-xl" />
                            <span className="text-gray-600 text-base">Promote academic excellence</span>
                        </div>
                    </div>
                </div>
            </div>
