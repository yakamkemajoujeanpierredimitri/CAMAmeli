    ...
    return (
        <section className="py-20 bg-gradient-to-br from-blue-500 to-blue-700 text-white text-center">
            <div className="container mx-auto px-4">
                <h2 className="text-4xl font-bold text-white relative mb-12">Our Impact<div className="absolute bottom-[-15px] left-1/2 -translate-x-1/2 w-20 h-1 bg-white rounded-full"></div></h2>
