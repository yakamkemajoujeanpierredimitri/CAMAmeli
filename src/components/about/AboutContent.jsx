        ...
        <>
                    <section className="py-20 bg-white">
                        <div className="container mx-auto px-4">
                            <h2 className="text-4xl text-center mb-12 text-gray-800 relative">Our History<div className="absolute bottom-[-15px] left-1/2 -translate-x-1/2 w-20 h-1 bg-blue-500 rounded-full"></div></h2>
                            
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                                <div className="history-text">
                                    <h3 className="text-3xl mb-6 text-gray-800">Foundation and Development</h3>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl text-center mb-12 text-gray-800 relative">Our Vision & Mission<div className="absolute bottom-[-15px] left-1/2 -translate-x-1/2 w-20 h-1 bg-blue-500 rounded-full"></div></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        <div className="bg-white rounded-lg p-10 shadow-lg transition duration-300 ease-in-out border border-gray-200 hover:-translate-y-2 hover:shadow-xl">
                            ...
                            <h3 className="text-2xl mb-5 text-gray-800 text-center">Our Vision</h3>
                        ...
                        <div className="bg-white rounded-lg p-10 shadow-lg transition duration-300 ease-in-out border border-gray-200 hover:-translate-y-2 hover:shadow-xl">
                            ...
                            <h3 className="text-2xl mb-5 text-gray-800 text-center">Our Mission</h3>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl text-center mb-12 text-gray-800 relative">Our Objectives<div className="absolute bottom-[-15px] left-1/2 -translate-x-1/2 w-20 h-1 bg-blue-500 rounded-full"></div></h2>
                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg transition duration-300 hover:translate-x-1">
                                ...
                                <span className="text-gray-700 text-lg font-medium">Train competent professionals</span>
                            </div>
                            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg transition duration-300 hover:translate-x-1">
                                <FontAwesomeIcon icon={faCheckCircle} className="text-blue-500 text-2xl mt-1" />
                                <span className="text-gray-700 text-lg font-medium">Develop educational innovation</span>
                            </div>
                            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg transition duration-300 hover:translate-x-1">
                                <FontAwesomeIcon icon={faCheckCircle} className="text-blue-500 text-2xl mt-1" />
                                <span className="text-gray-700 text-lg font-medium">Build a strong professional network</span>
                            </div>
                            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg transition duration-300 hover:translate-x-1">
                                <FontAwesomeIcon icon={faCheckCircle} className="text-blue-500 text-2xl mt-1" />
                                <span className="text-gray-700 text-lg font-medium">Promote academic excellence</span>
                            </div>
                            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg transition duration-300 hover:translate-x-1">
                                <FontAwesomeIcon icon={faCheckCircle} className="text-blue-500 text-2xl mt-1" />
                                <span className="text-gray-700 text-lg font-medium">Ensure rapid professional integration</span>
                            </div>
                            <div className="flex items-start gap-4 p-5 bg-gray-50 rounded-lg transition duration-300 hover:translate-x-1">
                                <FontAwesomeIcon icon={faCheckCircle} className="text-blue-500 text-2xl mt-1" />
                                <span className="text-gray-700 text-lg font-medium">Adapt our training to market changes</span>
                            </div>
                        </div>
                    </div>
                </div>
