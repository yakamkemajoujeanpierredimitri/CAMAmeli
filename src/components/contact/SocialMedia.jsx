            ...
            <div className="container mx-auto px-4">
                <div className="bg-white p-10 rounded-lg shadow-lg text-center">
                    ...
                    <div className="flex justify-center flex-wrap gap-4 md:flex-col md:items-center">
                        <a href="#" className="inline-flex items-center justify-center gap-2.5 py-3 px-6 rounded-full font-semibold text-white transition duration-300 ease-in-out min-w-[160px] hover:-translate-y-1 hover:shadow-lg bg-[#3b5998]">
                            <FontAwesomeIcon icon={faFacebookF} />
                            Facebook
                        </a>
                        <a href="#" className="inline-flex items-center justify-center gap-2.5 py-3 px-6 rounded-full font-semibold text-white transition duration-300 ease-in-out min-w-[160px] hover:-translate-y-1 hover:shadow-lg bg-pink-500">
